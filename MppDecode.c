...
#include "MppDecode.h"
#incldue "opencv2/core/core.hpp"
#include "opencv2/imgproc/imgproc.hpp
#include "opencv2/imgcodecs/imgcodecs.hpp"
int frame_null = 0;
void MppDecode::conv_yuv420_to_mat()
{
    RK_U32 width    = 0;
    RK_U32 height   = 0;
    RK_U32 h_stride = 0;
...
//        fwrite(base_c, 1, width, fp);
    ...
    cv::Mat rgbImg;
    cv::cvtColor(yuvImg, rgbImg, CV_YUV420sp2BGRA);
    cv::imwrite("/home/firefly/zlatan/newmpp.jpg", rgbImg);
